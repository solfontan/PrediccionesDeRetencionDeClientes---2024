...
print(X_train_resampled_france.columns)
...
with open(r'app\france.pkl', 'wb') as f:
...
print(X_train_resampled_spain.columns)
...
# # Guardar el modelo y el umbral óptimo en un archivo
with open(r'app\spain.pkl', 'wb') as f:
...
print(X_train_resampled_germany.columns)
...
# # Guardar el modelo y el umbral óptimo en un archivo
with open(r'app\germany.pkl', 'wb') as f:
